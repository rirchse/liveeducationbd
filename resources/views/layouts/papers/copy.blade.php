  ...
  <div class="row"> <!-- left column -->
    <div class="col-md-12"> <!-- general form elements -->
      <div class="box box-warning">
        ...
        <form action="{{route('paper.copy.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="paper_id" value="{{$value->id}}">
            <div class="box-body">
                <div class="col-md-3">
