...
<style>
  ...
  <section class="content-header">
    <h1>Teachers Accounts</h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Teachers</a></li>
      {{-- <li><a href="#">Tables</a></li> --}}
      <li class="active">Teachers Accounts</li>
    </ol>
  </section>
            ...
            <table id="example1" class="table table-bordered table-hover">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="{{route('teacher.edit', $value->id)}}" class="btn btn-warning" title="Edit this User"><i class="fa fa-edit"></i></a>
                  @if($value->status == 1)
