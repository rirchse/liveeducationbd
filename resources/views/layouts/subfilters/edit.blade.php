  ...
  <div class="row"> <!-- left column -->
    <div class="col-md-8"> <!-- general form elements -->
      <div class="box box-primary">
        ...
        <form action="{{route('sub-filter.update', $subfilter)}}" method="POST">
            @csrf
            @method('PUT')
            <div class="box-body">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="filter_id" id="filter_id" required>
                            ...
                            <option value="{{$val->id}}" {{$val->id == $subfilter->filter_id ? 'selected' : ''}}>{{$val->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="name" required value="{{$subfilter->name}}">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="details" id="details" rows="5">{{$subfilter->details}}</textarea>
                    </div>
                </div>
            </div> <!-- /.box body -->
